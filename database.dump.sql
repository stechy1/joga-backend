...
INSERT INTO `lecture_type` VALUES (1,'děti','popis pro děti',50,NULL),(2,'dospělí','poipasfdf',150,NULL),(9,'Jogínek','Dětská jóga hravou formou pro děti od 4- 6 let\n\nRučník s sebou, pohodlné, nejlépe bavlněné oblečení\n\nV případě nepřítomnosti budu ráda za informaci prostřednictvím paní učitelky, mailem, SMS, či na nově vznikajících stránkách: www.studioOM.cz',300,'e526f6c8d3afefeb1c8c57cfac1a031346a77926.png');
...
INSERT INTO `lectures` VALUES (2,2,1,1567317600,1567320300,10,'dsfasgvsfv',1),(3,2,2,1567320600,1567323300,15,'dfgsdgdf',1),(4,2,1,1567494900,1567499400,8,'gsdgdfbdsfgd',1),(5,2,2,1568186400,1568189100,15,'gsdgsdhbsbhgf',1),(6,2,1,1568207400,1568210400,4,'gdfsgdgfg',0),(8,2,1,1567750200,1567752600,10,'gdsfgbdsgbdf',1),(9,2,1,1567767600,1567770300,10,'gbdshbfdjgjmgh',1);
...
-- Dump completed on 2019-10-03 17:00:11
